...
var masterwordlist = [
	...
	["student","council","tax","return","gift","basket","weaving","Vidya"],
	...
	["lemon","lime","light","house","cat","walk","way",""],
	["bone","dry","land","mass","media","circus","clown",""],
	["blue","blood","hound","dog","tag","along","side",""],
	["code","name","drop","dead","heat","wave","pool",""],
	["world","fair","game","point","blank","paper","cup",""],
	["private","eye","candy","apple","pie","chart","topper",""],
	["outer","space","junk","food","chain","reaction","time",""],
	["wedding","ring","tone","deaf","ear","plug","in",""],
	["grand","jury","box","seat","cushion","cover","charge",""],
	["jet","black","coffee","shop","talk","show","down",""],
	["steam","train","car","race","track","team","sport",""],
	["arm","rest","stop","light","year","book","case",""],
	["key","lime","green","screen","door","prize","money",""],
	["banana","split","second","nature","trail","mix","tape",""],
	["couch","potato","skin","deep","dish","soap","opera",""],
	["close","second","class","photo","album","art","museum",""],
	["second","wind","sock","puppet","master","key","chain",""],
	["gummy","bear","market","research","paper","bag","pipes",""],
	...
	["late","night","sky","light","year","round","trip",""],
	["cup","cake","walk","off","duty","free","throw",""],
	["inside","job","fair","trade","secret","identity","crisis",""],
	["champagne","cork","screw","loose","end","table","salt",""],
	...
	["flash","mob","boss","battle","scar","tissue","paper",""],
	["high","tide","pool","table","cloth","diaper","bag",""],
	["garbage","truck","bed","room","number","pad","lock",""],
	["mission","critical","hit","single","ladies","first","responder",""],
	...
	["garden","hose","down","pour","over","time","out",""],
	["magazine","cover","letter","head","cold","water","slide",""],	
	["science","fair","weather","report","card","table","manners",""],
	["full","moon","dust","storm","front","page","turner",""],
	["spring","water","supply","closet","space","bar","tab",""],
	["lunch","box","car","pool","noodle","soup","kitchen",""],	
	["magic","kingdom","come","true","love","story","book",""],
	...
	["cap","gun","powder","room","service","road","trip",""],
	["wind","tunnel","vision","test","kitchen","counter","offer",""],
	["deep","freeze","dry","mouth","watering","can","opener",""],
	...
	["best","friends","forever","young","love","song","bird",""],
	["ketchup","bottle","neck","deep","dive","bar","mitzvah",""],
	["auto","pay","day","care","free","trade","show",""],
	["grand","slam","poetry","reading","room","key","card",""],
	["main","squeeze","bottle","rocket","science","fair","game",""],
	["studio","apartment","building","block","party","time","capsule",""],
	["stage","right","hand","shake","up","grade","school",""],
	["serving","spoon","feed","back","talk","radio","station",""],
	["arctic","ocean","front","cover","girl","scout","master",""],
	["green","thumb","war","paint","ball","pit","stop",""],
	["ghost","story","line","cook","book","fair","fight",""],
	["snow","flake","out","cold","shoulder","pad","lock",""],
	["sugar","free","lunch","lady","bug","spray","tan",""],
	...
	["news","flash","flood","warning","sign","language","arts",""],
	["air","pocket","money","pit","bull","market","share",""],
	["beaded","curtain","call","off","hand","ball","drop",""],
	["freezing","rain","fall","fashion","model","student","loan",""],
	["sure","fire","drill","sergeant","major","general","store",""],
	["giant","squid","ink","jet","black","top","heavy",""],
	["swan","song","bird","bath","water","proof","read",""],
	["happy","meal","ticket","window","seat","belt","buckle",""],
	["open","house","fire","sale","price","point","blank",""],
	["double","take","cover","story","time","warp","speed",""],
	["world","class","clown","car","pool","side","walk",""],
	["jelly","fish","tank","top","bunk","bed","bug",""],
	["flea","market","square","root","word","search","party",""],
	["hornet","nest","egg","salad","bowl","cut","loose",""],
	["traffic","jam","packed","lunch","break","point","guard",""],
	["sea","turtle","neck","pillow","top","dog","house",""],
	["taste","test","tube","top","heavy","weight","room",""],
	["graph","paper","towel","dry","spell","check","mate",""],
	["answering","machine","wash","board","game","night","owl",""],
	["immediate","family","vacation","home","state","house","work",""],
	["straight","razor","burn","rubber","chicken","soup","can",""],
	["pop","quiz","show","business","card","shark","bait",""],
	["finger","tip","toe","nail","file","cabinet","member",""],
	["field","day","care","package","deal","breaker","box",""],
	["red","hot","dog","pound","cake","pop","culture",""],
	...
	["straight","face","value","pack","rat","race","horse",""],
	["cabin","fever","dream","job","market","crash","course",""],
	["movie","star","fish","bowl","cut","off","guard",""],
	["smooth","jazz","hands","free","throw","pillow","talk",""],
	...
	["sales","pitch","black","ice","age","old","school",""],
	["wrist","watch","dog","tag","team","work","book",""],
	["busy","bee","line","dance","party","game","show",""],
	["magnet","school","lunch","counter","strike","gold","mine",""],
	["dumb","bell","hop","scotch","tape","measure","up",""],
	["boot","camp","fire","wood","work","shop","class",""],
	["smart","phone","call","sheet","music","box","office",""],
	["paper","thin","ice","pick","up","hill","top",""],
	["cold","feet","first","place","card","trick","play",""],
	["top","speed","dating","profile","picture","perfect","storm",""],
	["power","strip","mall","cop","car","alarm","clock",""],
	["alphabet","soup","kitchen","sink","hole","punch","card",""],
	["history","channel","surf","board","game","face","lift",""],
	["friendly","fire","hazard","pay","grade","school","night",""],
	["broken","record","player","piano","bar","stool","pigeon",""],
	["heavenly","body","part","time","table","top","soil",""],
	["full","moon","rock","solid","state","wide","awake",""],
	["flag","football","field","goal","post","card","game",""],
	...
	["bumper","sticker","shock","therapy","dog","park","ranger",""],
	["rocking","horse","shoe","string","bean","counter","top",""],
	...
	["wisdom","tooth","fairy","dust","storm","cloud","nine",""],
	...
	["diamond","ring","finger","food","fight","club","sandwich",""],
	["skin","deep","sea","food","bank","account","balance",""],
	["ginger","snap","pea","pod","cast","member","ship",""],
	...
	["mystery","guest","star","power","play","book","club",""],
	["hula","hoop","skirt","steak","house","party","favor",""],
	...
	["fourth","wall","street","lamp","post","man","hole",""],
	["wet","paint","job","security","blanket","statement","piece",""],
	["parking","meter","maid","service","dog","park","bench",""],
	["school","yard","sale","price","tag","team","spirit",""],
